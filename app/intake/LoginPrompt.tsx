...
/**
 * Shown on /intake when there's no logged-in session — e.g. a returning
 * visitor whose session expired. Sends a magic link rather than requiring
 * a password (PRD 5.1 allows either; magic link is the simpler build).
 */
